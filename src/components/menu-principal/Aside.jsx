...
export default function Aside() {
    return (
        <aside className="text-sm font-medium sm:text-base py-6 px-4 flex flex-col gap-4 border-r h-screen">
            ...
            <div className="flex flex-col gap-[1px]">
                ...
                <Link href={'/menu-principal/gestion-inventario'} className="flex flex-row items-center text-nowrap py-2 cursor-pointer px-4 rounded-md hover:bg-gray-100"><BsBoxSeam className="size-5 mr-2" />Gestión de inventario</Link>
            </div>
            ...
            <div className="flex flex-col gap-[1px]">
                ...
                <Link href={'/menu-principal/termino-condiciones'} className="flex flex-row items-center text-nowrap py-2 cursor-pointer px-4 rounded-md hover:bg-gray-100"><GrDocumentText className="size-5 mr-2" />Terminós y condiciones</Link>
            </div>
        </aside>
    )
}